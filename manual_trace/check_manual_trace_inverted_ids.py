#!/usr/bin/env python3
"""
Align a judge ballot CSV with the golden-truth atom list (inverted tetris).
...
Pure standard library. Run:  python check_manual_trace_inverted_ids.py
"""
...
GOLDEN_CSV = r"D:\dev\tetris_games\inverted_tetris\react_inverted_tetris_claude\compliance_check\manual_trace_inverted_tetris_react_by_claude.csv"
TARGET_CSV = r"D:\dev\tetris_games\inverted_tetris\react_inverted_tetris_claude\compliance_check\claude_opus_4_8.csv"
# -----------------------------------------------------------------------------
